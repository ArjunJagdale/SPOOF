...
Original file is located at
    https://colab.research.google.com/drive/1TwrgyU5V6fYXYGgfNaVbAFtQMzgqzX-X
...
zip_path = '/content/drive/MyDrive/antispoof_dataset.zip'

# Destination folder to unzip
extract_path = '/content/antispoof_dataset'
...
# Paths
old_path = '/content/antispoof_dataset/antispoof_dataset'
new_path = '/content/antispoof_dataset'

# Move train, val, test up one level
...
train_dir = '/content/antispoof_dataset/train'
val_dir = '/content/antispoof_dataset/val'
test_dir = '/content/antispoof_dataset/test'
